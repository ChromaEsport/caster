...
"Reine des Junkers":{role:"TANK",icon:"tank.png"},
...
"Chopper":{role:"TANK",icon:"tank.png"},
"Sigma":{role:"TANK",icon:"tank.png"},
"Winston":{role:"TANK",icon:"tank.png"},
"Bouldozer":{role:"TANK",icon:"tank.png"},
...
"Fatale":{role:"DAMAGE",icon:"damage.png"},
...
"Ange":{role:"SUPPORT",icon:"support.png"},  
